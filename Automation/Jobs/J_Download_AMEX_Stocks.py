...
#GLOBAL VARIABLES
_FILENAME ="amex_stocks_"+dt.getDateTime()+".data"
#****************
def amex_stocks_download():
    if not fw.FILE_EXISTS_PATTERN(_P.DATA_PATH,starts_with="amex_stocks_"):  
        URL = "https://api.nasdaq.com/api/screener/stocks"
        PARAMS = {"tableonly": "true", "limit": "25","exchange":"AMEX","download":"true"}
