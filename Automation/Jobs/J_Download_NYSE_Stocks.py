...
#GLOBAL VARIABLES
_FILENAME ="nyse_stocks_"+dt.getDateTime()+".data"
#****************
def nyse_stocks_download():
    if not fw.FILE_EXISTS_PATTERN(_P.DATA_PATH,starts_with="nyse_stocks_"):  
        URL = "https://api.nasdaq.com/api/screener/stocks"
        PARAMS = {"tableonly": "true", "limit": "25","exchange":"NYSE","download":"true"}
