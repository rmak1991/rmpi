...
def archive_nyse_stocks():
    if fw.FILE_EXISTS_PATTERN(_P.DATA_PATH,starts_with="nyse_stocks_"):  
        FILENAME = fw.FILE_NAME_PATTERN(_P.DATA_PATH,starts_with="nyse_stocks_")
